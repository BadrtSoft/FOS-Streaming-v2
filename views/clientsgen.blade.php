                        ...
                        <div id="demo-form2"  class="form-horizontal form-label-left" >
                            <div class="form-group">
                                ...
                                <div class="col-md-1 col-sm-1 col-xs-12">
                                    <a class="btn btn-info" href="javascript:;" onclick="copyToClipboard('#p1')" title="Copy">Copiar</a>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-1 col-sm-1 col-xs-12">
                                    <a class="btn btn-info" href="javascript:;" onclick="copyToClipboard('#p2')" title="Copy">Copiar</a>
                                </div>
                            </div>
                        </div>
                    </div>
